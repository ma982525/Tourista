<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $nnumber = mysqli_real_escape_string($db,$_POST['nnumber']);
	  ...
	  if ($_POST["cnumber"] == $row["Mobile"]) {
        mysqli_query($db, "UPDATE users set Mobile='" . $nnumber . "' WHERE Email='" . $_SESSION["Email"] . "'");
        $message = "Number Changed";
        
    } else
        $message = "Current Number is not correct";
...
<html>
   ...
   <head>
      <title>Change Number | Tourista</title>
   ...
   <body>
      ...
      <br>
       ...
       <div class="container z-depth-3" style="padding:15px 15px 15px 25px;">
          <h4 class="pink-text text-accent-3">Change Number</h4>
          <br>
          <form action="" method="post">
            ...
            <div class="row">
                <div class="input-field col l6 m6 s12">
                  <input id="pass" name="cnumber" type="text" class="validate  pink-text" required>
                  <label for="pass" class=" pink-text">Current Number</label>
                </div>
            </div> 
            <br>
            <div class="row">
                <div class="input-field col l6 m6 s12">
                  <input id="npass" name="nnumber" type="text" class="validate  pink-text" required>
                  <label for="npass" class=" pink-text">New Number</label>
                </div>
            </div>  
            <br>
            <div class="row">
            ...
            <?php
            if ($message=="Number Changed"){ 
                echo '<div class="row">
                <div class="col l12 m12 s12">
                  <button class="btn green lighten-3 black-text"><b>'.$message.'</b></button>
                </div>
            </div>'; }
            else if($message=="Current Number is not correct"){ echo '<div class="row">
                <div class="col l12 m12 s12">
            ...
            <div class="col l6 m6 s12">
                <img src="decide.svg" style="width:100%">
            </div>
            </div>
