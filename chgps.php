<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
	  ...
	  if ($_POST["cpassword"] == $row["Password"]) {
        mysqli_query($db, "UPDATE users set Password='" . $npassword . "' WHERE Email='" . $_SESSION["Email"] . "'");
...
<html>
   ...
   <head>
      <title>Change Password | Tourista</title>
   ...
   <body>
      ...
      <br>
       ...
       <div class="container z-depth-3" style="padding:15px 15px 15px 25px;">
          <h4 class="pink-text text-accent-3">Change Password</h4>
          <br>
          <form action="" method="post">
            ...
            <div class="row">
                <div class="input-field col l6 m6 s12">
                  <input id="pass" name="cpassword" type="password" class="validate  pink-text" required>
                  <label for="pass" class=" pink-text">Current Password</label>
                </div>
            </div> 
            <br>
            <div class="row">
                <div class="input-field col l6 m6 s12">
                  <input id="npass" name="npassword" type="password" class="validate  pink-text" required>
                  <label for="npass" class=" pink-text">New Password</label>
                </div>
            </div>  
            <br>
            <div class="row">
            ...
            else if($message=="Current Password is not correct"){ echo '<div class="row">
                <div class="col l12 m12 s12">
