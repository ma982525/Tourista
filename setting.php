   ...
   <body>
      ...
      <br>
       ...
       <div class="container z-depth-3" style="padding:15px 15px 15px 25px;">
          <h4 class="pink-text text-accent-3">Settings</h4>
          <br>
          <div class="row">
            <div class="col l6 m6 s12">
            <div class="row">
                <div class="col l6 m6 s12">
                  <button class="btn pink accent-3 hoverable"><a href="chgps.php" class="white-text"><b>CHANGE PASSWORD</b></a></button>
                </div>
            </div> 
            <br>
            <div class="row">
                <div class="col l6 m6 s12">
                  <button class="btn pink accent-3 hoverable"><a href="chgnu.php" class="white-text"><b>CHANGE NUMBER</b></a></button>
                </div>
            </div> 
            <br>
            <div class="row">
                <div class="col l6 m6 s12">
                  <button class="btn pink accent-3 hoverable"><a href="delete.php" class="white-text"><b>DELETE ACCOUNT</b></a></button>
                </div>
            </div> 
            </div>
            <div class="col l6 m6 s12">
                <img src="setting.svg" style="width:100%;">
            </div>
        </div>
       </div>
