...
<body>
  ...
  <div class="container">
        <h1 class="header center-align black-text" style="margin-top: 0;"><b><span class="pink-text text-accent-3">EXPLORE</span> INDIA</b></h1>
  </div>
    ...
    <div class="slider">
      ...
      <ul class="slides" style="height: 100%;"> 
        <li style="border:2px grey solid">  
          <img src="india/india-1.jpg" style="height: 100%;">    
        </li>  
        <li style="border:2px grey solid">  
          <img src="india/india-2.jpg" style="height: 100%;">   
        </li>  
        <li style="border:2px grey solid">  
          <img src="india/india-3.jpg" style="height: 100%;">  
        </li>  
        <li style="border:2px grey solid">  
          <img src="india/india-4.jpg" style="height: 100%;">  
        </li>  
      </ul> 
      ...
      <div class="col l6 hide-on-med-and-down">
        <div class="slider">
          <ul class="slides hoverable" style="width: 100%;"> 
            ...
            <li style="border:2px grey solid">  
              <img src="india/india-2.jpg" style="width: 100%;">   
            </li>  
            <li style="border:2px grey solid">  
              <img src="india/india-3.jpg" style="width: 100%;">  
            </li>  
            <li style="border:2px grey solid">  
              <img src="india/india-4.jpg" style="width: 100%;">  
            </li>
            <li style="border:2px grey solid">  
              <img src="india/india-5.jpg" style="width: 100%;">   
            </li>  
            <li style="border:2px grey solid">  
              <img src="india/india-6.jpg" style="width: 100%;">  
            </li>  
            <li style="border:2px grey solid">  
              <img src="india/india-7.jpg" style="width: 100%;">  
            </li>    
          </ul>
        </div> 
      </div>
