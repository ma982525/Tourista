<?php
	...
	$query = "insert into form1(Name, Mobile, Email) values('$name', '$number', '$email')";
...
<div class="container">
	<div class="Section center-align">
		<h3>Thankyou <?php echo $name; ?> for filling this form. Our expert will contact you shortly.</h3>
	</div>
</div>
