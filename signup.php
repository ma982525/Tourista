<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $query = "insert into users(Email, FName, LName, Mobile, Password) values('$Email', '$Fname', '$Lname', '$mob' ,'$mypassword')";
	  $submit = mysqli_query($db,$query) or die(mysqli_error($db));
   ...
   <body>
      ...
      <br>
       ...
       <div class="container z-depth-3" style="padding:15px 15px 15px 25px;">
          <h4 class="pink-text text-accent-3">Signup</h4>
          <br>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="input-field col l10 m10 s12">
                  <input id="firstName" name="FName" type="text" class="validate  pink-text" required>
                  <label for="firstName" class=" pink-text">First Name</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col l10 m10 s12">
                  <input id="lastName" name="LName" type="text" class="validate  pink-text" required>
                  <label for="lastName" class=" pink-text">Last Name</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col l10 m10 s12">
                  <input id="Email" name="email" type="email" class="validate  pink-text" required>
                  <label for="Email" class=" pink-text">Email</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col l10 m10 s12">
                  <input id="Number" name="Mobile" type="text" class="validate  pink-text" required>
                  <label for="Number" class=" pink-text">Mobile</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col l10 m10 s12">
                  <input id="email" name="password" type="password" class="validate  pink-text" required>
                  <label for="email" class=" pink-text">Password</label>
                </div>
            </div>
            <div class="row">
                <div class="col l10 m10 s12 left">
                  <button class="btn-large waves-effect waves-dark  white black-text hoverable" type="submit" style="margin-top: 25px;margin-bottom: 10px"><b>Signup</b>
