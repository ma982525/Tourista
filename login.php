   ...
   <body>
      ...
      <br>
       ...
       <div class="container z-depth-3" style="padding:15px 15px 15px 25px;">
          <h4 class="pink-text text-accent-3">Login</h4>
          <br>
        <form action="" method="POST">
        <div class="row">
            <div class="col l6 m6 s12">
            <div class="row">
                <div class="input-field s10 m10 l10">
                  <input id="UName" name="email" type="text" class="validate  pink-text" required>
                  <label for="UName" class=" pink-text">Email ID</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field  s10 m10 l10">
            ...
            <div class="row">
                <div class="col left s10 m10 l10">
                  <button class="btn-large waves-effect waves-dark  white black-text hoverable" type="submit" style="margin-top: 25px;margin-bottom: 10px"><b>Login</b>
            ...
            if($count != 1){
            echo '<div class="row  s10 m10 l10">
                <div class="col">
                    <button class="btn red accent-2"><b>'.$msg.'</b></button>
                </div>
            </div>';
            }
            ?>
